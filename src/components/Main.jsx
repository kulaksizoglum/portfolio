...
function Main() {
  return (
    <div>
      <div id="home" className="scroll-mt-24 flex mb-5 ml-10">
        <ArrowDown size={40} className="text-accent animate-bounce" />
        <p className="text-lg ml-40">
          Hello! I am <span className="text-accent">Murat Kulaksızoğlu</span>
        </p>
      </div>
      <div className="flex">
        <img src="me.webp" className="h-30 mt-2 " />
        <div className="flex-col ml-30 ">
          ...
          <p className="text-xl">
            Because every great product starts with a single solution.
          </p>
        </div>
      </div>
      ...
      <div className="text-xl">
        ...
        <p className="mt-1">
          1+ year of experience building user-focused applications. Interested
          in data,
        </p>
        <p className="mt-1">
          artificial intelligence, and leveraging technology to solve meaningful
          problems.
        </p>
      </div>
      <div className="border-t w-full mt-10 mb-10"></div>
      <div className="flex flex-col items-center">
        <p id="about" className="scroll-mt-24 text-center text-5xl">Education</p>
        <div className="w-1/2 rounded-2xl p-6 mt-10 bg-linear-to-br from-card/60 via-card/30 to-background border-t-2 border-t-accent shadow-[0_-8px_30px_rgba(157,102,56,0.35)] hover:shadow-[0_-10px_40px_rgba(157,102,56,0.5)] transition">
          <div className="flex flex-row ">
            <img src="sabanci.jfif" width={150} height={80} />
      ...
      <div className="border-t w-full mt-10 mb-10"></div>
      <WorkExperience />
      <div id="projects" className="scroll-mt-24 border-t w-full mt-10 mb-10"></div>
